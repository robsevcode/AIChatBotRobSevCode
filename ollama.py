...
def chat_with_ollama(system_prompt, history, history_input):
    ...
    if payload["messages"][-1]["role"] == "assistant":
        print("Last message was: ", payload["messages"][-1]["content"])
        payload["messages"].pop()
        print("New last message: ", payload["messages"][-1]["content"])
...
def generate_image_prompt(prompt):
    print("***")
    print("Generating prompt for avatar with Ollama")
    print("***")
    url = "http://localhost:11434/api/chat"
...
def generate_image_request_prompt(user_prompt, character_info):
    print("***")
    print("Generating prompt for requested image with Ollama")
    print("***")
    url = "http://localhost:11434/api/chat"
